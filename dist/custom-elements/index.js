...
const MyComponent = class extends HTMLElement {
  ...
  static get style() { return jointjsGraphComponentCss; }
};

const JointjsGraphComponent = /*@__PURE__*/proxyCustomElement(MyComponent, [1,"jointjs-graph-component",{"graphdata":[1]}]);
const defineCustomElements = (opts) => {
  if (typeof customElements !== 'undefined') {
    [
      JointjsGraphComponent
    ].forEach(cmp => {
...
export { JointjsGraphComponent, defineCustomElements };
